...
export const About = () => {
    ...
    return (
      ...
      <div>
      <h1 id='present_title' style={{color:'yellow'}}>Hello My name is jaba</h1>
      <motion.p 
        initial='hidden'
        animate='visible'
      ...
      >
         ...
         Nowadays I can boldly say that I found a profession that I love and really enjoy doing. <br/>
